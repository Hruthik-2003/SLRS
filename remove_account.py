...
class RemoveAccount(ctk.CTkToplevel):
    ctk.set_appearance_mode("light")
    ctk.set_default_color_theme("green")

    def __init__(self, user_type, id):
        ...
        def remove_activity():
            ...
            if user_id == "" or password == "" or con_pwd == "":
                ...
                try:
                    ...
                    del_query = "DELETE from user_table where user_id=%s AND password=%s"
                    if user_type == "user":
                        del_query = "DELETE from user_table where user_id=%s AND password=%s"
                    elif user_type == "admin":
                        del_query = "DELETE from admin_table where admin_id=%s AND password=%s"
...
if __name__ == '__main__':
    RemoveAccount("user", "hruthik").mainloop()
