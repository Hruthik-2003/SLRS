...
from tkinter.messagebox import *
import trainer_window as tw


class TrainerLogin(ctk.CTkToplevel):
        ...
        def login_activity():
            try:
                ...
                if admin_id == "" or password == "" or secretkey == "":
                    ...
                    select_query = "select * from trainer_table where trainer_id=%s AND (password=%s AND secrete_key=%s)"
                    ...
                    if rows is not None:
                        ...
                        if rows:
                            ...
                            if self.winfo_viewable():  # If root window is visible
                                ...
                                tw.TrainerWindow(row_data).deiconify()  # Show window2
                            else:
                                self.deiconify()  # Show root window
                                tw.TrainerWindow(row_data).withdraw()  # Hide window2
