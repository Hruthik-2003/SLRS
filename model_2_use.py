...
DATA_PATH = os.path.join(r"C:\Users\hruth\PycharmProjects\SignLanguageRecognition\SLR_model\MP_Data1")
actions = np.array(['hello', 'thanks', 'i want to eat'])
no_sequences = 30
sequence_length = 30
...
model = tf.keras.models.load_model(r'C:\Users\hruth\PycharmProjects\SignLanguageRecognition\SLR_model\action1.h5')
...
class RealTimeTest(ctk.CTkToplevel):
    ...
    def __init__(self):
        ...
        self.geometry("1000x540")  # Create a Label to capture the Video frames
        frame = ctk.CTkFrame(self, bg_color="red", height=500, width=700)
        frame.place(x=0, y=0)
        ...
        with mp_holistic.Holistic(min_detection_confidence=0.5, min_tracking_confidence=0.5) as holistic:
            while cap.isOpened():
                ...
                s_sequence01 = s_sequence01[-30:]

                if len(s_sequence01) == 30:
